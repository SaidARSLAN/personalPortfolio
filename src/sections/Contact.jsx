...
const Contact = () => {
  return ( 
    ...
    <div className='flex flex-col items-center justify-center lg:items-start'>
      <h3 className='text-lg font-poppins text-pOrange my-2 lg:text-xl'>CONTACT</h3>
      <h1 className='text-2xl font-poppins text-center w-full my-2 text-pBlack lg:text-left lg:text-3xl'>Reach out via the information provided</h1>
      </div>
      ...
      <div className='flex flex-col items-center justify-center text-center mt-8 lg:flex-row lg:space-x-6'>
        ...
        <div className='flex flex-col items-center justify-center lg:items-start'>
        <h3 className='font-bold text-xl font-poppins text-pBlack lg:text-2xl'>Location</h3>
        <p className='font-mulish font-semibold text-sm my-2 text-pGray lg:text-lg'>Manisa, Türkiye</p>
        </div>
      </div>
      <div className='flex flex-col items-center justify-center text-center mt-8 lg:flex-row lg:space-x-6'>
        ...
        <h3 className=' text-xl font-poppins text-pBlack lg:text-2xl'>Mail</h3>
        <p className='font-mulish font-semibold text-sm my-2 text-pGray lg:text-lg'>saidarslan389@gmail.com</p>
        </div>
      </div>
      </div>
      </section>
