...
const Hero = () => {
  return (
        <section className='flex flex-col lg:flex-row lg:px-24'>
            ...
            <h3 className='text-sm lg:text-lg text-pOrange font-roboto tracking-wide max-[380px]:text-[12px]'>Creating Algorithm and Responsive Web Design</h3>
            ...
            <div className='flex items-center justify-center w-full mt-9'>
                <img src={image} className='w-72 lg:w-96 duration-1000  rounded-full border-2 border-transparent  border-b-pOrange border-l-pOrange hover:w-80 lg:hover:w-[400px] hover:border-t-pOrange hover:border-r-pOrange hover:border-b-transparent hover:border-transparent'/>
            </div>
        </section>
  )
}
