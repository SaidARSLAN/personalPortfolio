...
const HiddenNavbar = () => {
  ...
  return (
    <ul className='w-0 z-50  fixed h-full lg:hidden flex-col overflow-hidden transition-all ease bg-pWhite justify-center duration-300 items-center text-center' id="downRef">
