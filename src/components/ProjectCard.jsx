...
const ProjectCard = ({project}) => {
  return (
    <div className='flex border-2 shadow-xl shadow-gray-500 m-4 px-12 py-12 flex-col lg:flex-row w-full'>
      <div className='flex items-center justify-center lg:mr-12 w-2/3'>
