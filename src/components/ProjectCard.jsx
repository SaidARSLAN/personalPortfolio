  ...
  return (
    <div className='flex flex-col border-2 p-12 rounded-2xl bg-white shadow-2xl lg:py-8 lg:px-16 justify-center items-center my-8 lg:flex-row lg:space-x-12 '>
        ...
        <div className='flex w-full justify-evenly mt-6'>
            <a href="/" className='bg-pWhite text-pOrange rounded-md font-poppins px-4 py-2 text-lg hover:bg-pOrange hover:text-pWhite duration-300'>Github</a>
            <a href="/" className='bg-pWhite text-pOrange rounded-md font-poppins px-4 py-2 text-lg hover:bg-pOrange hover:text-pWhite duration-300'>Live Demo</a>
        </div>
        </div>
    </div>
  )
