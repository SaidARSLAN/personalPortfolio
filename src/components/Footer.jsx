...
const Footer = () => {
  return (
    <div className='h-60 bg-pGray flex items-center flex-col  justify-center lg:flex-row lg:w-full lg:justify-around lg:h-40'>
        <h3 className='text-lg font-poppins text-pWhite max-[400px]:text-sm'>Copyright © 2023. All rights are reserved</h3>
