...
const Nav = () => {
  ...
  return (
        <header className='lg:px-4 shadow-md h-20 flex justify-between items-center w-full fixed bg-pWhite z-10'>
            <nav className='flex items-center justify-between px-12  max-[400px]:px-4 w-full'>
                <div className='text-2xl cursor-pointer font-poppins max-[400px]:text-lg  bg-gradient-to-r bg-clip-text from-black to-pOrange text-transparent'>
                    SaidARSLAN.dev
                </div>
